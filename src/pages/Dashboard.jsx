    ...
    <div style={S.shell}>
      ...
      <header style={S.topbar}>
        ...
        {clubConfig?.logo_url ? (
          ...
          <svg width="38" height="44" viewBox="0 0 38 44" fill="none" style={{ flexShrink: 0 }}>
            ...
            <text x="19" y="18.5" textAnchor="middle" fill={c}
                  fontFamily="'Exo 2', sans-serif" fontWeight="700" fontSize="9.5" letterSpacing="1.5">{initials}</text>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', flexShrink: 0, minWidth: 0 }}>
          <span style={{ fontFamily: "'Exo 2', sans-serif", fontWeight: 700, fontSize: isMobile ? '17px' : '20px', letterSpacing: '1px', lineHeight: 1, color: 'var(--text-pri)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: isMobile ? '130px' : 'none' }}>
            ...
            {activeTab === 'dashboard' && (
              <>
                ...
                <DashboardOverview
                  ...
                  diasGraciaMora={clubConfig?.dias_gracia_mora ?? 0}
