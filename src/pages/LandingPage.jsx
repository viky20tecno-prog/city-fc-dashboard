  ...
  return (
    <div className="landing-page" style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#060810', minHeight: '100vh', color: '#fff', overflowX: 'hidden' }} onMouseMove={onMove} onMouseLeave={onLeave}>
      ...
      <style>{`
        ...
        .hero-bolt {
          fill:none; stroke:url(#hero-bolt-grad); stroke-width:1.3;
          stroke-linecap:round; stroke-linejoin:round;
          filter:url(#hero-bolt-glow); stroke-dasharray:10 50;
          animation:hero-bolt-flicker var(--dur) ease-in-out var(--delay) infinite,
                    hero-bolt-travel calc(var(--dur) * 2.4) linear var(--delay) infinite;
        }
